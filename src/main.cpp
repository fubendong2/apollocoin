...
uint256 hashGenesisBlock("0x68b83d48f8d21878fa299d5bbee1142f8399d6d2e8ad59646cf095ae7d82e0ba");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Apollocoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Apollocoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
	...
	}else if (nHeight < 5720)
	{
		nSubsidy = 0.0001 * COIN;
	}else if (nHeight == 5721)
	{
...
static const int64 nTargetTimespan = 60 * 60;	// Apollocoin: 1 hour
static const int64 nTargetSpacing = 30;						// Apollocoin: 30 sec
static const int64 nInterval = nTargetTimespan / nTargetSpacing;
static const int64 nTargetTimespanRe = 60 * 60; // 60 Minutes
static const int64 nTargetSpacingRe = 30; // Apollocoin: 30 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
   ...
   if(fNewDifficultyProtocol) {
    ...
    // Apollocoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal apollocoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Apollocoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x68b83d48f8d21878fa299d5bbee1142f8399d6d2e8ad59646cf095ae7d82e0ba");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "apollocoin coin ";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1395398547;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1673290;
        ...
        assert(block.hashMerkleRoot == uint256("0x99bac3206fa7ef27f9be29ef7231c5a89d2fbf3bfeb531b8715eecb828327246"));
...
{
	return false;
	//commenting out this code until we properly implement APL alerts.
	/*
    if (!CheckSignature())
        return false;
    if (!IsInEffect())
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Apollocoin: increase each by adding 2 to bitcoin's value.
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // Apollocoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
